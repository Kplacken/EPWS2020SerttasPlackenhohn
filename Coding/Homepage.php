...
<body>
    ...
    <form  method="post" action="http://127.0.0.1/Homepage.php" >

        <div class="morgens" style="background-color: rgb(238, 230, 224)">
            <div>
        ...
        <div class="abends" style="background-color: rgb(238, 230, 224)" style="margin-top: 20px;">
            <div>
        ...
        <button id="add-btn" type="submit" name="action" value="Senden" style="margin: 10px 0 0 60px; background-color: rgb(238, 230, 224);">Speichern</button>
    </form>
